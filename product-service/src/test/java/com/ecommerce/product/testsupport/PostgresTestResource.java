...
/**
 * Starts a PostgreSQL Testcontainer for Quarkus tests.
 * This ensures that we run against a real database with Flyway migrations.
 * 
...
public class PostgresTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        try {
            ...
            // Ensure Flyway runs against the Testcontainer DB
