...
/**
 * Testcontainers-backed Postgres for inventory-service integration tests.
 *
...
public class PostgresTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        try {
            ...
            // Kafka configuration will be provided by KafkaTestResource
            // This resource only handles Postgres configuration
